...
namespace StringDB {
	...
	public class Database : IEnumerable<KeyValuePair<string, string>> {
		...
		public void InsertRange(Dictionary<string, string> range) => this._writer.InsertRange(range);

		/// <summary>Inserts a range of data into the database.</summary>
		/// <param name="range">The pieces of data to insert.</param>
		public void InsertRange(Tuple<string, string>[] range) => this._writer.InsertRange(range);
